...
df = pd.read_csv("/Users/anishbanerjee/Desktop/master_graph_results.txt", sep=" ")
...
axs[0][0].set_ylabel("CONSTANT = NO OF COMPARISONS / N LOG2 N")
...
axs[0][1].set_ylabel("CONSTANT = NO OF COMPARISONS / N LOG2 N")
...
axs[1][0].set_ylabel("CONSTANT = NO OF COMPARISONS / N LOG2 N")
...
axs[1][1].set_ylabel("CONSTANT = NO OF COMPARISONS / N")
