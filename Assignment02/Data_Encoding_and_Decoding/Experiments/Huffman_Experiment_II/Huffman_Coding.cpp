...
void length_calc(string original_file, double &entropy, vector<Node*>& nodes)
{
    ...
    for (auto const& [key, value] : freq_map)
    {
...
int main()
{
    ...
    for (int i = 0; i < original_files_list.size(); i++)
    {
        ...
        length_calc(original_files_list[i], entropy_list[i], nodes);
